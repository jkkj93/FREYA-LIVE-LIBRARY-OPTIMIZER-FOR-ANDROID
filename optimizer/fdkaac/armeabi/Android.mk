...
LOCAL_CFLAGS += -DNDEBUG -static -mfpu=vfp -mfloat-abi=softfp -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -fPIC -O3 -march=armv5te -mtune=arm1176jzf-s -ftree-vectorize -ffast-math
LOCAL_ARM_MODE := arm
